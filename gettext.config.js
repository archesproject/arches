...
module.exports = {
    input: {
        ...
        // Arches core, plus the applications bundled under arches/extensions.
        // The bundled applications version and release with arches rather than
        // separately, so they extract into arches' own catalog (see output.path
        // below) instead of carrying per-application ones: one release ships one
        // set of translations, and Django finds them via the "arches" app's
        // locale directory without any extra LOCALE_PATHS entry.
        include: [
            "app/src/**/*.vue",
            "app/src/**/*.ts",
            "extensions/*/src/**/*.vue",
