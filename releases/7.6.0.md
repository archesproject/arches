...
7. Update your project's JavaScript dependencies:
    1. Remove your `media/node_modules` directory and `yarn.lock` file

    2. In your terminal navigate to the directory with your project's package.json file. Then run:
    ```
    yarn install
    ```
