...
- 10804 Search has been re-architected to be totally component-based, now governed by `search-logic` components. See [docs](https://arches.readthedocs.io/en/latest/developing/reference/search-components/) for more details.
