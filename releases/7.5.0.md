...
- Add tile excel importer branch excel exporter in bulk data manager #9978
- Add branch and tile excel exporters in bulk data manager #9978
- Save workflow history to database #9959
- Add node configuration for requiring files to be images #9333 #9934
- Adds arches applications #9426
- Add accessibility fixes for the public facing side of Arches #10265

### Additional highlights

- Adds map config hook #10354
...
- Add detailed progress status in bulk editor #10268
...
- Adds workflow history endpoint #10154
...
- Improve the bulk-editor preview query #9952
