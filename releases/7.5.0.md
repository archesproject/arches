...
- Tile Excel format importer added to bulk data manager #9978
- Branch and tile Excel exporters added to bulk data manager #9978
- Improvements to bulk data manager editors #10156 #10268 #9952
- Workflow progress saved to database to persist history and track incomplete workflows #9959, #10154
- Image mode added to file-list datatype to save alt text and other image metadata #9934
- Ability to install Arches Applications #9426
- Many accessibilty improvements #10265
...
- Adds map config hook for map widget customization #10354
