...
4. If you have javascript dependencies listed in `webpack/webpack-node-modules-aliases.js`, move them to your package.json file. For example, if you have dependencies in `webpack/webpack-node-modules-aliases.js` like this:
    ```
    module.exports = {
...
8. Update your project's JavaScript dependencies:
    ...
    2.  Ensure `nodeModulesPaths` is added to your `package.json` file:
        ```    
        {
            "dependencies": {
                "arches": "archesproject/arches#stable/7.5.0",
