...
-   Update CSV import to better handle complex models, add download template functionality [#11918](https://github.com/archesproject/arches/pull/11918)
### Dependency changes:
...
3.  If you are upgrading from a version prior to 7.6.7, you'll need to rebuild your frontend bundle:
