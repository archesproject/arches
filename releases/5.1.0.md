...
1. Update your Javascript dependencies
    ...
    The new **preferred** way is to make arches a dependency in your project's package.json file like so:
    ...
    Alternatively you can simply update your project with the latest arches dependencies. Be aware, your dependencies can fall out of 
