...
***BEFORE UPGRADING:*** be sure to import any graphs that you need in your system because you will not be able to import them after the upgrade
...
1. Be sure to import any graphs that you need in your system because you won't be able to do it after the upgrade.

2. Be sure to backup your database before proceeding

3. Upgrade to Arches 5.1
...
5. If you are maintaining an Arches package, be sure to export your graphs and resource instance data before reimporting or reloading your package.
