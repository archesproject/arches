...
- `createVueApplication`, `generateArchesURL`, `ArchesPreset`, and `DEFAULT_THEME` in `arches` are deprecated in favor of their equivalents in `arches-component-lab` [#12824](https://github.com/archesproject/arches/pull/12824)
