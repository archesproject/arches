...
- `createVueApplication` (`arches/app/media/js/utils/create-vue-application.js`) is deprecated in favor of `createVueApplication` from `arches-vue-components` (`import { createVueApplication } from '@/arches_vue_components/application'`). The `arches-vue-components` version includes Pinia support. [#12823](https://github.com/archesproject/arches/pull/12823)

- `generateArchesURL` (`arches/app/src/arches/utils/generate-arches-url.ts`) is deprecated in favor of `generateArchesURL` from `arches-vue-components` (`import { generateArchesURL } from '@/arches_vue_components/application'`). [#12823](https://github.com/archesproject/arches/pull/12823)

- `ArchesPreset` and `DEFAULT_THEME` (`arches/app/src/arches/themes/default.ts`) are deprecated in favor of `ArchesPreset` and `DEFAULT_THEME` from `arches-vue-components` (`import { ArchesPreset, DEFAULT_THEME } from '@/arches_vue_components/themes'`). [#12823](https://github.com/archesproject/arches/pull/12823)
