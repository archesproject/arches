...
- `createVueApplication` (`arches/app/media/js/utils/create-vue-application.js`) is deprecated in favor of `createVueApplication` from `arches-component-lab` (`import { createVueApplication } from '@/arches_component_lab/application'`). The `arches-component-lab` version includes Pinia support. [#12823](https://github.com/archesproject/arches/pull/12823)

- `generateArchesURL` (`arches/app/src/arches/utils/generate-arches-url.ts`) is deprecated in favor of `generateArchesURL` from `arches-component-lab` (`import { generateArchesURL } from '@/arches_component_lab/application'`). [#12823](https://github.com/archesproject/arches/pull/12823)

- `ArchesPreset` and `DEFAULT_THEME` (`arches/app/src/arches/themes/default.ts`) are deprecated in favor of `ArchesPreset` and `DEFAULT_THEME` from `arches-component-lab` (`import { ArchesPreset, DEFAULT_THEME } from '@/arches_component_lab/themes'`). [#12823](https://github.com/archesproject/arches/pull/12823)
