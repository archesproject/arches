...
- Fix an issue where the file info from the frontend is ignored when it goes through transform_value_for_tile (e.g. arches-querysets) [#12900](https://github.com/archesproject/arches/issues/12900)
