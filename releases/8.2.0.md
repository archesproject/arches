...
- Add `External Domain` base datatype, enabling subclasses to back domain nodes with any Django model rather than per-node configuration [#12730](https://github.com/archesproject/arches/pull/12730)
