...
If you are upgrading your project from 4.1.0, you should review the project upgrade steps from 4.1.0 to 4.1.1 before proceeding.

    https://github.com/archesproject/arches/blob/master/releases/4.1.1.md#upgrading-an-arches-project
