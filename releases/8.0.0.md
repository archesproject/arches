...
- The format of JavaScript files has changed. Please refer to `Upgrading an Arches project`
- The format of how some images are loaded in template files has changed. Please refer to `Upgrading an Arches project`
