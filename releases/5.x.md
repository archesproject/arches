...
| Test Subject                                           | Chrome | Firefox | UI  | Notes |
| ------------------------------------------------------ | :----: | :-----: | --- | ----- |
| User can add a related resource                        |    ?    |    ?    | ?   |#5414|
| User can delete a related resource                     |   ?    |    ?    | ?   |#5414|
...
| Add collection                         |    ?    |    ?    | ?   | -     |
| Delete collection                      |    ?    |    ?    | ?   | -     |
| Export all collections                 |    ?    |    ?    | ?   |this action redirects to this url with inline xml file:/concepts/export/collections|
| Add dropdown entry                     |    ?    |    ?    | ?   | -     |
| Add sort order and confirm in dropdown |:x:|    ?    | ?   |(?)In some cases custom sorting reverts to alphabetical order|
...
| -------------------------------------------------------------------------------------| :----: | :-----: | --- | ----- |
| Create new Project                                                                   |    ?    |    ?    | ?   | -     |
| Save project upon selecting resource type and data entry card(s)                     |:x:|    ?    | ?   | -     |
