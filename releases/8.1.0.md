...
1. Rebuild your frontend bundle:
    ...
    - This version removes `copy-webpack-plugin` from arches-dev-depenencies. For this reason, you'll want to be sure that the `arches-dev-dependencies` property in your project's package.json file points to either the `dev/8.1.x` or `stable/8.1.0` branch.
