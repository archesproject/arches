...
-   Add capability to import the file with the metadata so that the metadata can be imported with the bulk data importer [#12370](https://github.com/archesproject/arches/pull/12370)
