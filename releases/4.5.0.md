...
Update Arches to use the latest Elasticsearch
    ...
    This will put the latest version of Elasticsearch into the directory from which you ran the previous commands.  At this point you can move the elasticsearch-6.6.2 directory to a new location if you desire.
    
    Now stop the currently running Elasticsearch instance.
    Then copy the `data` directory from your old Elasticsearch instance to the new instance
