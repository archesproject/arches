Arches 6.2.9 release notes
--------------------------
### Bug Fixes and Enhancements

- Clean markup from search queries
...
2. Upgrade to Arches 6.2.9

    If using a virtual environment, be sure to activate it:

        pip install --upgrade arches==6.2.9
...
3. Update your Javascript dependencies
    ...
    Ensure your arches dependency points to either `#archesproject/arches#dev/6.2.x` or `#archesproject/arches#stable/6.2.9`.\
    For example:
