...
| Test Subject                                                             | Chrome |  Firefox | UI  | Notes |
| ------------------------------------------------------------------------ | :----: | :-----: |  --- | ----- |
| User can sign themselves up for a new Arches account                     |:x:|    ?    | ?   |#5746 #5814|
...
| Advanced search                                                                                                                                                                      |:construction:|  ?  |   ?   |#5815|
...
| Import from SPARQL |:question:|    ?    | ?   |The list is not refreshed on import|
