...
INSERT INTO functions(functionid, function, functiontype, name, description, config)
    VALUES ('60000000-0000-0000-0000-000000000010', 'primarynamelookup', 'primaryname', 'Primary Name Lookup', 'A function to calculate the primary name from a nodegroup', '{"template":""}');
