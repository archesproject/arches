...
export default async function createVueApp(originEntityName, vueComponent){
    /**
    ...
    **/ 
    return fetch(`/api/get_frontend_i18n_data?originEntityName=${originEntityName}`).then(resp => {
        if (!resp.ok) {
