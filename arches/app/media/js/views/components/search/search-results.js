                ...
                if (!!this.searchResults.results){
                    ...
                    this.searchResults.results.hits.hits.forEach(function(result){
                        ...
                        this.results.push({
                            ...
                            can_read: result._source.permissions.users_without_read_perm.indexOf(this.userid) < 0,
                            can_edit: result._source.permissions.users_without_edit_perm.indexOf(this.userid) < 0,
