...
//             console.log("()DS()DS()SD()SDDS()", arches.urls)
...
define(['jquery',
    ...
    'bootstrap-datetimepicker',
    'plugins/knockout-select2'],
function($, _, BaseFilter, bootstrap, arches, foo, select2, ko, koMapping, GraphModel, viewdata) {
    ...
    return ko.components.register(componentName, {
        ...
        // template: { require: 'templates/views/components/search/search-results.htm' }
        template: foo
    });
});