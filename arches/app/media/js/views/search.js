define([
...
], function($, _, ko, arches, AlertViewModel, SearchComponents, BaseFilter, TimeFilter, TermFilter, MapFilter, ProvisionalFilter, AdvancedSearch, ResourceTypeFilter, RelatedResourcesManager, SearchResults, SavedSearches, BaseManagerView, viewData, searchData) {
    ...
    var SearchView = BaseManagerView.extend({
        initialize: function(options) {
            ...
            _.extend(this.viewModel, new CommonSearchViewModel());
