    ...
    */
    var SavedSearchesViewModel = function(params) {
        ...
        self.items = ko.observableArray([
            ...
            {image: mediaUrl + 'uploadedfiles/q4.jpg', title:'Query 6 Name', subtitle: 'Query 6 subtitle', searchUrl: 'search?termFilter=%5B%7B"inverted"%3Afalse%2C"type"%3A"string"%2C"context"%3A""%2C"context_label"%3A""%2C"id"%3A"bart"%2C"text"%3A"bart"%2C"value"%3A"bart"%7D%5D&no_filters=false&page=1'}
        ]);
        self.options = {
