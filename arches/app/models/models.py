...
class MobileSurveyModel(models.Model):
    ...
    createdby = models.ForeignKey(User, related_name='createdby', on_delete=models.SET_NULL)
    lasteditedby = models.ForeignKey(User, related_name='lasteditedby', on_delete=models.SET_NULL)
