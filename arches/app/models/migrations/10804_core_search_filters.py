...
class Migration(migrations.Migration):
    ...
    sql = """
        ...
        UPDATE search_component SET type = 'search-results' WHERE componentname = 'search-results';
        ...
        UPDATE search_component SET type = 'map-filter' where componentname = 'map-filter';
