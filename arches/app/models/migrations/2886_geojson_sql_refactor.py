        ...
        migrations.RunSQL("""
                ...
                CREATE MATERIALIZED VIEW mv_geojson_geoms AS
                    SELECT t.tileid,
                        ...
                        n.nodeid,
                        st_transform(st_setsrid(st_geomfromgeojson((json_array_elements((t.tiledata::json -> n.nodeid::text) -> 'features'::text) -> 'geometry'::text)::text), 4326), 900913)::geometry(Geometry,900913) AS geom
                    FROM tiles t
