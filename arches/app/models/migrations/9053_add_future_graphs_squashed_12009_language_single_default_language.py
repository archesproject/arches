...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            ...
            reverse_code=remove_default_resource_instance_lifecycle,
        ),
        migrations.RunPython(
            code=create_default_resource_instance_lifecycle_states,
            reverse_code=remove_default_resource_instance_lifecycle_states,
        ),
        migrations.RunPython(
            code=create_perpetual_resource_instance_lifecycle,
            reverse_code=remove_perpetual_resource_instance_lifecycle,
        ),
        migrations.RunPython(
            code=create_perpetual_resource_instance_lifecycle_states,
            reverse_code=remove_perpetual_resource_instance_lifecycle_states,
        ),
        migrations.AddField(
            model_name="graphmodel",
        ...
        migrations.RunPython(
            ...
            reverse_code=remove_default_resource_instance_lifecycles_from_graphs,
        ),
        migrations.AddConstraint(
            model_name="graphmodel",
