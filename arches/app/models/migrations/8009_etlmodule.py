    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(blank=True, null=True)),
                ('load_event', models.ForeignKey(db_column='transactionid', on_delete=django.db.models.deletion.CASCADE, to='models.LoadEvent')),
                ('nodegroup', models.ForeignKey(db_column='nodegroupid', on_delete=django.db.models.deletion.CASCADE, to='models.NodeGroup')),
            ],
            options={
