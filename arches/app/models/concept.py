    ...
    def bulk_index(self):
        ...
        if self.nodetype == 'ConceptScheme':
            ...
            for topConcept in self.get_child_concepts_for_indexing(self.id, depth_limit=1):
                ...
                concept_docs.append(se.create_bulk_item(index='concepts', doc_type='_doc',
...
class ConceptValue(object):
    ...
    def index(self, scheme=None):
        if self.category == 'label':
            ...
            se.index_data(index='concepts', doc_type='_doc', body=data, idfield='id')
    ...
    def get_scheme_id(self):
        se = SearchEngineFactory().create()
        result = se.search(index='concepts', doc_type='_doc', id=self.id)
        if result['found']:
...
def get_valueids_from_concept_label(label, conceptid=None, lang=None):
    ...
    concept_label_results = se.search(index='concepts', doc_type='_doc',
