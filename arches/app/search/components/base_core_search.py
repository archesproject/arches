...
#     "modulename": "base_core_search.py",  # the name of this file
#     "classname": "BaseCoreSearch",  # the classname below",
#     "type": "core",  # 'core' if you want this to govern the search
#     "componentpath": "views/components/search/...",  # path to ko component
#     "componentname": "my-core-search",  # lowercase unique name
#     "config": {
