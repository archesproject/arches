...
from arches.app.utils.frontend_configuration_utils.generate_tsconfig_paths import generate_tsconfig_paths
from arches.app.utils.frontend_configuration_utils.generate_urls_json import generate_urls_json
from arches.app.utils.frontend_configuration_utils.generate_webpack_configuration import generate_webpack_configuration
...
def _generate_urls_json_file(base_path):
    ...
    with open(destination_file_path, "w", encoding="utf-8") as destination_file:
        json.dump(
            {"_comment": "This file is auto-generated. Do not edit manually.", **generate_urls_json()},
            destination_file,
            indent=4,
        )
...
def _generate_webpack_configuration_file(base_path):
    destination_path = os.path.realpath(
        os.path.join(
            base_path, "..", "frontend_configuration", "webpack-metadata.json"
        )
    )
