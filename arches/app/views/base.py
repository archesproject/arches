...
from arches.app.utils.permission_backend import get_createable_resource_types, user_is_resource_reviewer, get_editable_resource_types, get_resource_types_by_perm
...
class BaseManagerView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["user_can_read"] = len(get_resource_types_by_perm(self.request.user, ["models.write_nodegroup", "models.delete_nodegroup", "models.read_nodegroup"])) > 0
