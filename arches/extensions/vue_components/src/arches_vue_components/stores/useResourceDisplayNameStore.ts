...
import { fetchRelatableResources as fetchSingleRelatableResource } from "@/arches_vue_components/datatypes/resource-instance/api.ts";
import { fetchRelatableResources as fetchListRelatableResources } from "@/arches_vue_components/datatypes/resource-instance-list/api.ts";

import type { ResourceInstanceSelectOption } from "@/arches_vue_components/datatypes/resource-instance/types.ts";
import type { ResourceInstanceListOption } from "@/arches_vue_components/datatypes/resource-instance-list/types.ts";

export const useResourceDisplayNameStore = defineStore(
    "arches_vue_components:resourceDisplayName",
    () => {
