...
urlpatterns = [
    ...
    url(r"^graph/(?P<graphid>%s)/restore_state_from_serialized_graph$" % uuid_regex, GraphPublicationView.as_view(action="restore_state_from_serialized_graph"), name="restore_state_from_serialized_graph"),
    url(r"^graph/(?P<graphid>%s)/update_published_graphs$" % uuid_regex, GraphPublicationView.as_view(action="update_published_graphs"), name="update_published_graphs"),
