...
from arches.app.views.graph import (
    ...
    GraphSettingsView,
    GraphDataView,
    GraphPublicationFooView,
    GraphPublicationBarView,
...
urlpatterns = [
    ...
    url(r"^graph/(?P<graphid>%s)/publish_foo$" % uuid_regex, GraphPublicationFooView.as_view(), name="publish_foo"),
    url(r"^graph/(?P<graphid>%s)/publish_bar$" % uuid_regex, GraphPublicationBarView.as_view(), name="publish_bar"),
