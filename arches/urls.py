...
urlpatterns = [
    ...
    url(r"^api/specific_resource_report_data/(?P<resourceid>%s|())$" % (uuid_regex), api.ResourceSpecificResourceReportData.as_view(), name="api_specific_resource_report_data"),
