...
from arches.app.views.admin import ReIndexResources, FileView, ClearUserPermissionCache, TransformEdtfForTile
...
urlpatterns = [
    ...
    url(r"^transform-edtf-for-tile", TransformEdtfForTile.as_view(), name="transform_edtf_for_tile"),
]
