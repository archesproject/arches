...
sudo apt-get install -y postgresql-9.5-postgis-2.2 postgresql-contrib
...
cd /home/ubuntu/arches/arches
wget http://www.legiongis.com/safe/arches/settings_local.py
