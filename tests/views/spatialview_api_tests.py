...
class SpatialViewApiTest(TransactionTestCase):
    ...
    def test_spatialview_api_crud(self):
        ...
        new_spatialview_json = self.create_json_data_object_from_spatialview(new_spatialview)
        ...
        self.assertEqual(response_json["spatialviewid"], str(new_spatialview.spatialviewid))
        ...
        self.assertEqual(response_json["geometrynodeid"], str(new_spatialview.geometrynode.pk))
        self.assertEqual(response_json["ismixedgeometrytypes"], new_spatialview.ismixedgeometrytypes)
        ...
        self.assertEqual(response_json["attributenodes"], new_spatialview.attributenodes)
        ...
        updated_spatialview_json = self.create_json_data_object_from_spatialview(updated_spatialview)
