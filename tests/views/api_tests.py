...
class APITests(ArchesTestCase):
    ...
    def test_find_unique_branch_from_jsonld(self):
        ...
        branch = resource_api.findBranch(graphtree['children'], "http://www.cidoc-crm.org/cidoc-crm/P1_is_identified_by", jsonld_graph[
                                         "http://www.cidoc-crm.org/cidoc-crm/P1_is_identified_by"])
    ...
    def test_cant_find_branch_from_jsonld(self):
        ...
        with self.assertRaises(resource_api.DataDoesNotMatchGraphException) as cm:
            branch = resource_api.findBranch(graphtree['children'], "http://www.cidoc-crm.org/cidoc-crm/P1_is_identified_by",
    ...
    def test_find_branch_from_complex_jsonld(self):
        ...
        resource_api = Resources()
        branch = resource_api.findBranch(graphtree['children'], "http://www.cidoc-crm.org/cidoc-crm/P41i_was_classified_by",
    ...
    def test_find_leaf_branch(self):
        ...
        for child in graphtree['children']:
            if child['node'].name == "Name":
                node = child
        resource_api = Resources()
        branch = resource_api.findBranch(node['children'], "http://www.cidoc-crm.org/cidoc-crm/P1_is_identified_by", jsonld_graph[
                                         "http://www.cidoc-crm.org/cidoc-crm/P1_is_identified_by"])
